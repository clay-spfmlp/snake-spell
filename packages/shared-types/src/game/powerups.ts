export interface PowerUp {
  ...
  duration: number; // How long it lasts on the field
...
export interface PowerUpDefinition {
  ...
  color: string;
  spawnWeight: number; // How likely to spawn (higher = more common)
}
...
export interface PowerUpActivatedMessage {
...
export interface PowerUpExpiredMessage {
  type: 'powerup_expired';
  playerId: string;
  powerUpType: PowerUpType;
}

export interface PowerUpSpawnedMessage {
...
export type PowerUpMessage = 
  | PowerUpCollectedMessage
  | PowerUpActivatedMessage
  | PowerUpExpiredMessage
  | PowerUpSpawnedMessage
  | UsePowerUpMessage;
